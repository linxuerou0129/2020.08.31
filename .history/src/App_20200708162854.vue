<template>
<div id="app">
<el-menu :default-active="$route.path" class="el-menu-demo" text-color="#fff" mode="horizontal" @select="handleSelect" text-color="#9fcefd" active-text-color="#1989fa" router>
