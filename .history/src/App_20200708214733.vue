<template>
<div id="app">
<el-menu :default-active="$route.path" mode="horizontal" @select="handleSelect" text-color="#F7D372" active-text-color="#f8b600" router>
  ...
  <el-submenu class="head3" v-if="login">
    <template slot="title">
  ...
  <el-submenu v-if="!login" class="head4">
    <template slot="title" font-size="20px">
      <strong>登录/注册</strong>
    </template>
