...
<div class="content">
    ...
    <img src="../assets/touxiang.jpeg" width="160" style="border-radius: 50%;position: absolute;z-index: 9999;top:39%;left:16.5%">
</div>
</template>
    ...
    created(){
      axios({
            ...
            .then((response)=>{
                 ...
                 imageUrl="http://47.107.243.207/api"+response.data.头像;
                 name=response.data.用户名;
            })
