<template>
<div id="app">
<el-menu :default-active="$route.path" class="el-menu-demo" mode="horizontal" @select="handleSelect" text-color="#9fcefd" active-text-color="#1989fa" router>
  <img src="./assets/logo.png" width="160px" class="logo">
  <el-menu-item index="/" class="head1"><strong>疫情报告</strong></el-menu-item>
  <el-menu-item index="/about" class="head2"><strong>讨论专区</strong></el-menu-item>
<el-dropdown  v-if="!login" class="head4">
  ...
  <el-dropdown-menu slot="dropdown">
    ...
    <el-dropdown-item>
      <el-button type="text" @click="loginFormShow = true">登录</el-button>
    </el-dropdown-item>
  </el-dropdown-menu>
</el-dropdown>
...
<el-dialog title="登录" :visible.sync="loginFormShow">
  ...
  <el-submenu index="2" class="head3" v-if="login">
    <template slot="title">
