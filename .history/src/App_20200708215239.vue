<template>
<div id="app">
<el-menu :default-active="$route.path" mode="horizontal" @select="handleSelect" text-color="#EFCE74" active-text-color="#f8b600" router>
  ...
  <el-submenu v-if="!login">
    <template slot="title"  class="head4">
      <strong>登录/注册</strong>
    </template>
